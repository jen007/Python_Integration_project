...
questions = ["How many cast members are currently active on Running Man?"
             "\nA. 9\nB. 7\nC. 8\nD. 5",
             "Running Man celebrated their 10 anniversary during which episode?"
             "\nA. 512\nB. 300\nC. 410\nD. 511 ",
             "What year was Running Man was almost cancelled?"
             "\nA. 2017\nB. 2012\nC. 2019\nD. 2015 ",
             "Which two hollywood actor appeared in Running Man?"
             "\nA. Jack Black and Angelina Jolie"
             "\nB. Tom Cruise and Ryan Reynolds "
             "\nC. Ryan Reynolds and Jack Hughman "
             "\nD. none of the above",
             ]
...
## The user answer will be compared with the values that exist in the list of answers
## If the user answer is true then a print statement will be given to congratulate the user and a point will be awarded
## If the answer is wrong no point is awarded.
## The last printed statement calculates the total amount of correct answer and gives a grade percentage
...
def running_man_knowlegde_quiz():
    score = 0
...
## the last printed statement will show the amount of correct answer the user got correct and the grade percentage
def math_quiz():
    score = 0
    for math_question, math_answer, math_explanation in zip(math_questions, math_answers,
                                                            math_explanations):
        print(math_question)
...
def true_false():
    score = 0
    for true_or_false_question, solution, true_false_explanation in zip(true_or_false_questions,solutions,
                                                                        true_false_explanations):
